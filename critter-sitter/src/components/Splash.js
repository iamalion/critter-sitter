...
function Splash() {
  ...
  return (
      ...
      <Container>
      <Paragraph>Critter Sitter is the ultimate pet parent's companion. Whether you're the proud owner of a feisty Fido or a fluffy Fifi, this app is your go-to solution for staying on top of all your pet's needs. With Critter Sitter, you can effortlessly track feeding schedules, daily walks, grooming and vet appointments, and more!
      </Paragraph>
